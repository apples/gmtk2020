...
function scene.init()
    ...
    new_platform((world_width / 2) - 5, 5)
    new_platform((-world_width / 2) + 5, 5)
    new_platform((world_width / 2) - 4, 5)
    new_platform((-world_width / 2) + 4, 5)
    new_platform((world_width / 2) - 3, 5)
    new_platform((-world_width / 2) + 3, 5)
    new_platform((world_width / 2) - 2, 5)
    new_platform((-world_width / 2) + 2, 5)
    new_platform((world_width / 2) - 6, 5)
    new_platform((-world_width / 2) + 6, 5)
    new_platform((world_width / 2) - 7, 5)
    new_platform((-world_width / 2) + 7, 5)
